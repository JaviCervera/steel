...
class CTRTextureGouraudAddNoZ2 : public ITriangleRenderer2
{
public:

	//! constructor
	CTRTextureGouraudAddNoZ2(IZBuffer2* zbuffer);
...
//! constructor
CTRTextureGouraudAddNoZ2::CTRTextureGouraudAddNoZ2(IZBuffer2* zbuffer)
...
/*!
*/
void CTRTextureGouraudAddNoZ2::scanline_bilinear ( sScanLineData * data ) const
{
	tVideoSample *dst;
